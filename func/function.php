...
function WPLS_addScript(){
	$script = '<script type="text/javascript" src="' . get_bloginfo('wpurl') . '/wp-content/plugins/wp-localstorage/js/wp-localstorage.js"></script>';
	echo $script;
}
...
function WPLS_addScript_admin(){
	...
	$script .= '}';
	$script .= '</script>';
	$script .= '<script type="text/javascript" src="' . get_bloginfo('wpurl') . '/wp-content/plugins/wp-localstorage/js/wp-localstorage-posts.js"></script>';
